...
const variants: Record<Variant, string> = {
  primary:
    "bg-accent text-on-accent shadow-[0_10px_30px_-12px_rgba(45,139,139,0.55)] hover:-translate-y-0.5 hover:bg-[#247373] hover:shadow-[0_16px_44px_-14px_rgba(45,139,139,0.6)]",
  secondary:
