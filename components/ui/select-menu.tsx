...
export function SelectMenu({
  ...
  // it escapes any overflow-hidden ancestor (e.g. a ruled panel cell). Flips
  // above the trigger when there isn't room below — important for selects low
  // on screen.
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      {/* Render after mount only — the panel opens on user click (post-
          ...
          Portal structure escapes overflow clipping; styling is the flat
          editorial panel (square, no glass/blur). */}
          ...
          <AnimatePresence>
            {open && pos && (
              <motion.div
                ...
                className="z-[80] overflow-y-auto overscroll-contain rounded-none border border-line-strong bg-panel p-1 shadow-[0_10px_28px_-14px_rgba(26,23,20,0.45)]"
              >
                {isEmpty ? (
